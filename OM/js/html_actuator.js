...
dogeSayings = ['MATTI RUOHO', 'Ilman laskinta!', '\"Tää oli jo ala-asteella\"', 'Ville on iha ez!', 'Silmät kiinni!', 'Voiko olla helpompaa!', 'Hikke!', 'Muista laskusäännöt!', 'Nyt laskemaan!', 'Voitko tehä mun villet?', 'Nyt on kova!', 'Päässälaskuja' ,'Ihan helppo',
    'Normipäivä!', 'Onko lisätehtäviä?','Jakokulma!','Kynä sauhuaa!','Helppoa ku heinänteko!','Helppo lasku!','Laskusäännöt hallussa!','Ei perkele että toi on hikke!','Mensaan siitä!','Jeees!!','10+']
